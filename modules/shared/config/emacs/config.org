...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Joss"
    user-mail-address "joss.sparkes@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/josspemsel/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/josspemsel/bin" "/profile/bin" "/Users/josspemsel/.npm-packages/bin" "/Users/josspemsel/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
